...
sys.path.append('/Users/rajan/habitat-sim/build/lib.macosx-10.9-x86_64-3.6')
print(sys.path)
import os
...
def main(display=True):
    ...
    backend_cfg.scene.id = (
        "/Users/rajan/habitat-sim/data/scene_datasets/habitat-test-scenes/skokloster-castle.glb"
    )
    ...
    #print("right_rgb_sensor position UP = {}".format(right_rgb_sensor.position))

    #right_rgb_sensor.position = 0.25 * habitat_sim.geo.RIGHT
    #print("right_rgb_sensor position RIGHT = {}".format(right_rgb_sensor.position))
    ...
    sim = habitat_sim.Simulator(habitat_sim.Configuration(backend_cfg, [agent_config,agent_config]))
